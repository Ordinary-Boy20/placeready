...
const LoginPage: React.FC = () => {
  ...
  const syncUserProfile = async (firebaseUser: any) => {
    // 1. Check Firestore for existing record
    ...
    if (userDocSnap.exists()) {
      ...
      // 2. Fallback to Local Storage check for existing mock data
      ...
      if (localUser) {
        profile = { ...localUser, uid: firebaseUser.uid };
      } else {
      ...
      // Save new/migrated profile to Firestore
