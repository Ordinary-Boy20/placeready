        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {filteredCompanies.map(company => (
            <div 
              ...
              className="group bg-white rounded-[48px] p-10 shadow-[0_10px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_30px_70px_rgba(66,133,244,0.12)] transition-all duration-500 border border-slate-100 flex flex-col items-center text-center cursor-pointer transform hover:-translate-y-4"
            >
              {/* Premium Logo Container */}
              <div className="relative mb-10">
                <div className="w-32 h-32 bg-gradient-to-br from-white to-slate-50 rounded-[40px] shadow-2xl shadow-blue-100 flex items-center justify-center p-1 border border-slate-100 relative z-10 overflow-hidden group-hover:scale-110 transition-transform duration-500">
                  <img 
                    src={company.logo} 
                    alt={company.name} 
                ...
                {/* Logo Shadow/Glow Background */}
                <div className="absolute inset-0 bg-blue-400 blur-3xl opacity-0 group-hover:opacity-20 transition-opacity rounded-full"></div>
              </div>
              ...
              <div className="flex-grow">
                ...
                <p className="text-slate-500 mb-8 text-sm leading-relaxed font-medium line-clamp-2 px-4">
                  {company.description}
                </p>
